...
// Determine win/loss/draw label from the perspective of the home team.
// Assumes the first team in the fixture string is Bont (home).
      ...
      {loading ? (
        ...
        <div className="page__body">
          {results.map((item) => {
            ...
            const hasFooter =
              (item.scorers && item.scorers.length > 0) || item.manOfMatch;
